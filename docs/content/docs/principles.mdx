...
If you delete the database, you lose nothing. Run `hbd sync` and it rebuilds from your `.tickets/` files. Your issues live in git, travel with your code, and merge like any other file.
...
| `helix-docs` | Cache and search fetched documentation |
| `helix-map` | Index codebase structure |
| `helix-mail` | Route messages between agents |
